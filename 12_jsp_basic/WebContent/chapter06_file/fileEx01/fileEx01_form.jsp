...
<body>
	...
	<form action="fileEx01_upload.jsp" method="post" enctype="multipart/form-data">
		<fieldset>
			...
			<p>파일명 : <input type="file" name="fileName"></p>
	...
	<fieldset>
		...
		<table border="1">
			<tr>
				<td><img src="../../img/404.PNG" width="70" height="70"></td>
				<td>404 에러 이미지</td>
				<td><a href="fileEx01_download.jsp?fileName=404.PNG">다운로드</a></td>
			</tr>
			<tr>
				<td><img src="../../img/500.PNG" width="70" height="70"></td>
				<td>500 에러 이미지</td>
				<td><a href="fileEx01_download.jsp?fileName=500.PNG">다운로드</a></td>
			</tr>
			<tr>
				<td><img src="../../img/notebook.PNG" width="70" height="70"></td>
				<td>notebook 이미지</td>
